...
\documentclass[language=english,titlepage=false,smartquotes]{hgbreport}
...
\title{MET2UE Media Technology II -- SS 2025\\ % Name of the course
...
\texttt{language=english} to \texttt{language=german}. If you write in MS Word (and such), try
...
\begin{figure}[htbp]
	\centering\small
	\begin{tabular}{cc}
		\fbox{\includegraphics[width=0.45\textwidth]{screenshot-dirty}} &  %
		JPEG
		\fbox{\includegraphics[width=0.45\textwidth]{screenshot-clean}} \\ %
		PNG
		(a) & (b)
	\end{tabular}
