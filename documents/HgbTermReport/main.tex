...
\end{quote}
%
In addition, \texttt{smartquotes=true} is used in this document
for simplified insertion of quotes. To omit the default \emph{title page}
(as in this document) use \texttt{titlepage=false}, \eg,
%
\begin{quote}
	\verb!\documentclass[language=english,titlepage=false]{hgbreport}!.
\end{quote}
%
