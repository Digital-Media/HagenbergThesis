...
The correct translation for "diploma thesis" is \emph{Diplomarbeit}, a
"master's thesis" is called \emph{Masterarbeit}. For "bachelor's thesis",
...
switched from English to German to get the correct form of hyphenation. With
the \texttt{smartquotes} option, the quotation marks are also adapted to the
respective language automatically (see Sections \ref{sec:language-switching}
and \ref{sec:quotation-marks}).
