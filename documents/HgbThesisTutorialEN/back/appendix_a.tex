...
A current \latex\ installation (\latex\ kernel 2022-06-01 or newer; the current
version of TeX~Live or MiKTeX is recommended) including
%
\begin{itemize}
		\item \texttt{biber} (modern replacement for BibTeX) and the \texttt{biblatex}
			package in matching versions,
...
\item \textbf{TeXstudio}%
	...
	(text editor with UTF-8 support and an integrated PDF viewer).
\end{enumerate}
%
...
\item 
	...
	On older versions, \emph{TeX Live} can alternatively be installed with a special
