...
a \latex online editor---nothing should stand in the way of getting started.
...
is not considered professional typesetting software, although major
...
trained eye---and the creation of books and similarly large documents is poorly
...
template, Appendix~\ref{app:Materials} lists the supplementary materials
submitted digitally, and Appendix~\ref{app:Questionnaire} shows an example of
including a multi-page PDF document.
