...
simply be accepted blindly but with caution. Their use must also be stated in
the documentation of AI tools usage (see Section~\ref{sec:DocumentingAIUsage}).
...
\begin{table}
	...
	\fbox{%
		...
		\begin{itemize}
			...
			\item[$\Box$] \textbf{Affidavit:}
				complete signature.
			\item[$\Box$] \textbf{Documentation of AI tools usage:}
				applicable text modules, complete information.
