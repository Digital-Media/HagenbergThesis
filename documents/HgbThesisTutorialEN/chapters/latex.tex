...
möglichen Alternativen finden sich in Anhang~\ref{app:TechnicalDetails}.
...
\end{quote}
%
Besonders nützlich sind auch \citetitle{Pakin2021} \cite{Pakin2021} und die
...
%
\noindent
Beispiele:\ \verb!\label{cha:Introduction}! oder \verb!\label{fig:Screen-1}!.
Mit den Anweisungen
%
\begin{quote}
...
%
\begin{quote}
    \verb!.. wie in Kap.~\ref{cha:Introduction} erwähnt ..!\\
