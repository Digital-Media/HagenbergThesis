...
\begin{itemize}
		...
		\item[] \texttt{proposal=true} (exposé, in connection with 
...
\begin{itemize}
    ...
    optional (default: provided by the title page theme), \newline%
    \verb!\programtype{!\texttt{\em Type of program}\verb!}! --
    optional (default: derived from \texttt{type}), \newline%
    \verb!\academicdegree{!\texttt{\em Academic degree}\verb!}! --
    optional (free text instead of the class option \texttt{degree}).
\end{itemize}
%
\noindent
