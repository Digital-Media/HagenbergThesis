...
\documentclass[language=english,twocolumn=true,smartquotes=true]{hgbarticle}
% Valid options in [..]:
...
%		Two-column layout: twocolumn=true, twocolumn=false (default)
%		Review mode with line numbers: review=true, review=false (default)
...
%
\begin{verbatim}
\documentclass[language=english,twocolumn=true,
            smartquotes=true]{hgbarticle}
\end{verbatim}
%
at the top of this document by
%
\begin{verbatim}
\documentclass[language=german,twocolumn=true,
    smartquotes=true]{hgbarticle}
\end{verbatim}
%
Use \texttt{twocolumn=false} for a single-column layout. Use \texttt{smartquotes=false}
to disable simplified quotations.
...
problems with mathematical structures \cite{Downes2017}. While smaller
equations like
%
\begin{equation}
x = a + b
...
%%%-----------------------------------------------------------------------------
\printbibliography      % alternatively use: \MakeBibliography[nosplit]
%%%-----------------------------------------------------------------------------
