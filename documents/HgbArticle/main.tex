...
\documentclass[language=english,twocolumn=true,smartquotes]{hgbarticle}
% Valid options in [..]:
%		Main language: language=german (default), language=english
%		Typographic quotes: smartquotes (= smartquotes=true), smartquotes=false
%		APA citation style: apa (= apa=true), apa=false
%		Two-column layout: twocolumn=true, twocolumn=false (default)
%		Review mode with line numbers: review (= review=true), review=false
%		Page layout: twoside=false (single-sided, default), twoside=true (double-sided)
%		No update check: noUpdateCheck (= noUpdateCheck=true)
%%%-----------------------------------------------------------------------------
...
%
\begin{verbatim}
\documentclass[language=english,twocolumn,
...
%
\begin{verbatim}
\documentclass[language=german,twocolumn,
    smartquotes]{hgbarticle}
\end{verbatim}
%
