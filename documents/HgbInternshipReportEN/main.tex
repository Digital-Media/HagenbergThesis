...
\documentclass[type=internship,theme=default,language=english,titlelanguage=english,smartquotes=true]{hgbthesis}
...
%    Code listings (codestyle=): color (default), mono, classic
...
%\programtype{Bachelor's degree program} % optional, default: derived from type=
...
% Documentation of AI tools usage: use the applicable text modules and delete anything that does
% not apply. Any other types of use that do not appear on this list must be clarified with your
% supervisor in advance. Detailed documentation (aiusagedetails): see the manual.
\begin{aiusage}
