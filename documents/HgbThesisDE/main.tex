...
\documentclass[master,german,smartquotes,proposal]{hgbthesis}
% Zulässige Optionen in [..]: 
%    Typ der Arbeit: 'master' (default), 'bachelor', 'diploma', 'internship'
...
%\usepackage{hgbtheme-custom} % select a custom front page layout
