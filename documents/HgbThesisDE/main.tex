...
\documentclass[type=master,english,titlelanguage=english,smartquotes]{hgbthesis}
...
\programname{Fachhochschul-Masterstudiengang Universal Computing}
\institution{Fachhochschule Oberösterreich}

%\titlelanguage{english} % specify the language used in front pages (default is the main laguage)
