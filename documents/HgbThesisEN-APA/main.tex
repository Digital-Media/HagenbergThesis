...
\documentclass[type=bachelor,theme=default,language=english,titlelanguage=english,smartquotes=true,apa=true]{hgbthesis}
...
\academicdegree{Master of Science in Engineering (MSc)} % optional
