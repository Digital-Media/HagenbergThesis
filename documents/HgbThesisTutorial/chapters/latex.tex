...
%
\begin{LaTeXCode}[numbers=none]
Geht es beispielsweise um die \ac{jpg}, so wird der Begriff beim ersten Mal ausgeschrieben, wird \ac{jpg} nochmals verwendet, folgt die Abkürzung. Dies gilt auch für ein \ac{ufo}. \ac{pi} und \ac{c} zählen zur Nomenklatur.
\end{LaTeXCode}
%
wie folgt gesetzt:

\begin{quote}
Geht es beispielsweise um die \ac{jpg}, so wird der Begriff beim ersten Mal ausgeschrieben,
wird \ac{jpg} nochmals verwendet, folgt die Abkürzung. Dies gilt auch für ein \ac{ufo}.
