...
Der Anspruch an ein ansehnliches Erscheinungsbild von Tabellen ist in den letzten
...
\begin{enumerate}
	...
	\item Unterführungszeichen, wie etwa Anführungszeichen, werden nicht benutzt, um einen Wert zu wiederholen.
	Meist reicht eine leere Spalte völlig aus. Falls nicht, sollte der Wert wiederholt werden.
\end{enumerate}
...
\texttt{longtable} bietet ebenfalls eine \verb|\caption|-Anweisung, die jedoch Teil der Tabelle ist und daher mit \verb|\\|
...

{
	...
	\begin{longtable}{@{}lp{0.2\textwidth}@{}}
