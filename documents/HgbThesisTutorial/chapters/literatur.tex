...
\texttt{biblatex}-Handbuch \cite{Kime2020} ansehen, beispielsweise
...
\cite[Abschn.\ 4.9.2.11]{Kime2020}. Andernfalls (wenn unbekannt oder wirklich
...
eines oder mehrerer Heiliger aufbewahrt werden \cite{WikiReliquienschrein2020}.
%
\begin{itemize}
\item[]
\begin{GenericCode}[numbers=none]
