...
wohingegen \textcite{Oetiker2018, Kopka2003} bereits mehr ins Detail gehen.
\end{LaTeXCode}
\item[] 
Daniel et al. (2018) geben eine kurze Einführung in das Thema \latex, wohingegen Kopka und Daly (2003)
und Oetiker et al. (2018) bereits mehr ins Detail gehen.
\end{itemize}
...
\item[]
Auf jeden Fall empfiehlt es sich, Literatur zum Thema \latex zu besorgen 
(\zB Daniel et al., 2018; Kopka \& Daly, 2003; Oetiker et al., 2018).
\end{itemize}
...
Werke (Kopka \& Daly, 2003; Oetiker et al., 2018).
\end{itemize}
...
\item
Oetiker, T., Partl, H., Hyna, I. \& Schlegl, E. (2018).
\textit{The Not So ShortIntroduction to \LaTeX2e: Or \LaTeX2e in 139 minutes.}
Version 6.2. \url{http://mirrors.ctan.org/info/lshort/english/lshort.pdf}.
(Siehe S. 6, 7)
\end{list}
\end{sloppypar}
