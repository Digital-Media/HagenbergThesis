...
\documentclass[type=master,theme=default,language=german,titlelanguage=german,smartquotes=true]{hgbthesis}
...
\programtype{Masterstudiengang} % oder Bachelorstudiengang
