...
\footnote{Dieses Setup basiert auf dem PDF-Management des \latex-Kerns (Paket
\texttt{pdfmanagement} \bzw\ \texttt{pdfmanagement-testphase} bei älteren
Distributionen) und erfordert daher eine aktuelle \latex-Distribution.}
Wird keine PDF/A-Ausgabe benötigt, kann diese Anweisung einfach entfernt werden.
Die Schriften (Latin Modern mit T1-Kodierung, s.\ Abschn.~\ref{sec:Schriftarten})
...
\end{itemize}
%
Abbildung \ref{fig:verapdf-report} zeigt ein Beispiel.
...
PDF-Datei genügt in diesem Fall. Die Eidesstattliche Erklärung wird dann
entweder digital im Dokument signiert oder der Studiengang holt sie auf andere
Art und Weise ein. Es empfiehlt sich, die Abgabemodalitäten rechtzeitig in Erfahrung zu
...
auf einem qualitativ hochwertigen Drucker (typischerweise einem
\emph{Laserdrucker}) geschehen; Ausdrucke mit einfachen Tintenstrahldruckern
sind dafür meist weniger gut geeignet. Auch das verwendete
...
oder mithilfe der Messgrafik am Ende dieses Dokuments.
