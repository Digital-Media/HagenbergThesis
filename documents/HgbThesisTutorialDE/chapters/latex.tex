...
in Deutsch gibt. Zahlreiche weitere Dokumente zu \latex und verwandten Themen
...
\end{quote}
%
Besonders nützlich sind auch \citetitle{Pakin2024} \cite{Pakin2024} und die
...
\begin{itemize}
	\item[] \texttt{[type=master,language=english,twoside=false]} % theme=default,
\end{itemize}
verwendet.%
...
\begin{itemize}
    ...
    optional (Standard: laut Theme der Titelseite), \newline%
    \verb!\programtype{!\texttt{\em Typ des Studiums}\verb!}! --
    optional (Standard: abgeleitet aus \texttt{type}), \newline%
    \verb!\academicdegree{!\texttt{\em Akademischer Grad}\verb!}! --
    optional (Freitext anstelle der Klassenoption \texttt{degree}).
\end{itemize}
%
\noindent
...
\begin{table}
    ...
    \begin{tabular}{@{}lcccc@{}}
        ...
        \verb!\title!            & $+$ & $+$ & $+$ & $+$ \\
        \verb!\author!           & $+$ & $+$ & $+$ & $+$ \\
        \verb!\programtype!      & $\circ$ & $\circ$ & $\circ$ & $\circ$ \\
        \verb!\programname!      & $+$ & $+$ & $+$ & $+$ \\
        \verb!\institution!      & $\circ$ & $\circ$ & $\circ$ & $\circ$ \\
        \texttt{degree=}, \verb!\academicdegree! & $\circ$ & $\circ$ & $\circ$ & $-$ \\
        \verb!\placeofstudy!     & $+$ & $+$ & $+$ & $+$ \\
