...
\documentclass[language=german,titlepage=false,smartquotes]{hgbreport}
% Zulässige Optionen in [..]:
%    Hauptsprache: language=german (default), language=english
%    Umwandlung in typografische Anführungszeichen: smartquotes (= smartquotes=true), smartquotes=false
%    APA Zitierstil: apa (= apa=true), apa=false
%    Titelseite: titlepage=true (default), titlepage=false
%    Layout: twoside=false (einseitig, default), twoside=true (zweiseitig)
%    Kein Update-Check: noUpdateCheck (= noUpdateCheck=true)
%%%-----------------------------------------------------------------------------
...
\title{MET2UE Media Technology II -- SS 2025\\ % Name der Übung
...
\arabic{chapter}). Man beachte, dass das \verb!\chapter!-Makro selbst
...
sowie allfällige eigene Entdeckungen zusammenfassen. Interessant könnte auch
sein, wie viel Zeit man insgesamt für die Übung aufwenden musste. Die
Überschrift dieses Abschnitts ist übrigens nicht nummeriert -- sie wurde mit
dem Makro \verb!\section*{..}! erzeugt.
