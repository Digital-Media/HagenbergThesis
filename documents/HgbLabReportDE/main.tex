...
\documentclass[language=german,titlepage=false,smartquotes=true]{hgbreport}
% Zulässige Optionen in [..]:
%    Hauptsprache: language=german, language=english (default)
%    Typografische Anführungszeichen: smartquotes=true, smartquotes=false (default)
%    APA Zitierstil: apa=true, apa=false (default)
%    Code-Listings: codestyle=color (default), codestyle=mono, codestyle=classic
...
\title{MET2UE Media Technology II -- SS 2027\\ % Name der Übung
