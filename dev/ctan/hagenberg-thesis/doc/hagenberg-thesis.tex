...
Note that customization is typically done at the institutional level and not
...
particular style file (\latex\ package) named \verb!hgbtheme-<themeID>.sty!.
...
Any theme style must at least define the
\begin{itemize}
