...
- 2026/09/14: [#227](https://github.com/Digital-Media/HagenbergThesis/issues/227): Corrected the date format in the German source reference below the detailed documentation of AI tools usage ("22. Mai 2023" instead of "Mai 22, 2023" as in the FH OÖ template).
- 2026/09/14: [#227](https://github.com/Digital-Media/HagenbergThesis/issues/227): Fixed the warning for an unconfirmed statement in the detailed documentation of AI tools usage (missing `\aiconfirm{accuracy}` or `\aiconfirm{responsibility}`), which was never issued. All warnings of `hgbaiusage` now have a self-contained first line, since editors such as TeXstudio only show the first line of a warning.
