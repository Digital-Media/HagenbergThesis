...
Die gängigste Methode ist die Verwendung von \texttt{BibTeX} \cite{Patashnik1988} 
%\cite[Kap.\ 12]{Kopka2003} 
\bzw 
...
die Angabe von weiteren Details (\zB\ \texttt{author} oder \texttt{institution}) ist aber natürlich möglich.
...
Es solltenach Möglichkeit bei jedem Quelleneintrag angegeben werden, also beispielsweise
\begin{quote}
...
\verb!edition={3}!
bei einer dritten Auflage. Die richtige Interpunktion in der Quellenangabe wird 
...
wenn es keine andere Auflage gibt!
