...
Mit der Standardeinstellung von \latex\ (\dah, \emph{ohne} Verwendung der Dokumentenoption 
\texttt{\texttt{smartquotes}})
...
Manche Editoren (\zB\ TeXnicCenter) kann man so einstellen, dass
...
(Silbentrennung, Hyphenation) unerlässlich.
