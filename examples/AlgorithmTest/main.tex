...
\Procedure{BicubicInterpolation}{$I, x, y$} \Comment{$x,y \in \R$}
	...
	\State $\mathit{val} \gets 0$ Very long texts should have the same indentation should have the same indentation 
should have the same indentation should have the same indentation should have the same indentation 
should have the same indentation.

\StateL{Very long texts should have the same indentation should have the same indentation 
should have the same indentation should have the same indentation should have the same indentation 
should have the same indentation.}
...
%\StateXX[1] StateXX[2] leftmargin = \the\leftmargin, listparindent = \the\listparindent,
						%labelwidth = \the\labelwidth Very long texts should have the same indentation 
						%should have the same indentation 
	%should have the same indentation should have the same indentation should have the same indentation 
	%should have the same indentation.
%\StatexIndent[1] StatexIndent Very long texts should have the same indentation should have the same indentation 
%should have the same indentation should have the same indentation should have the same indentation 
%should have the same indentation.
\State State \Comment{another comment}
\Statex Statex
...
\For{$e \in \mathit{edgesSorted}$}
	\StateNN[2]{no need to explore more. we just want to stop over here.}
	\If{$||e|| > \mathit{lastDistance}$}
		\State State
		\StateNN{StateNN}
		\Statex Statex 
