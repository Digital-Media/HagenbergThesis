...
\verb!\academicdegree{Master of Science (MSc)}!.
...
\begin{tabular}{@{}lll@{}}
	\toprule
	\texttt{degree=} & \texttt{type=bachelor} & \texttt{type=master} \\
	\midrule
	\texttt{arts-design}         & Bachelor of Arts in Arts and Design (BA)      & Master of Arts in Arts and Design (MA) \\
	\texttt{engineering}         & Bachelor of Science in Engineering (BSc)      & Master of Science in Engineering (MSc) \\
	\texttt{social-sciences}     & Bachelor of Arts in Social Sciences (BA)      & Master of Arts in Social Sciences (MA) \\
	\texttt{business}            & Bachelor of Arts in Business (BA)             & Master of Arts in Business (MA) \\
	\texttt{military-leadership} & Bachelor of Arts in Military Leadership (BA)  & Master of Arts in Military Leadership (MA) \\
	\texttt{police-leadership}   & Bachelor of Arts in Police Leadership (BA)    & -- \\
	\texttt{security-management} & --                                            & Master of Arts in Security Management (MA) \\
	\texttt{cultural-studies}    & Bachelor of Arts in Cultural Studies (BA)     & Master of Arts in Cultural Studies (MA) \\
	\texttt{natural-sciences}    & Bachelor of Science in Natural Sciences (BSc) & Master of Science in Natural Sciences (MSc) \\
	\texttt{health-studies}      & Bachelor of Science in Health Studies (BSc)   & Master of Science in Health Studies (MSc) \\
	\texttt{law}                 & Bachelor of Laws (LLB)                        & Master of Laws (LLM) \\
	\bottomrule
\end{tabular}
\end{table}
