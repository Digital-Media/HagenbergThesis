...
\begin{itemize}
  ...
  \item \texttt{hgbaiusage.sty}: documentation of AI tool usage (for \texttt{hgbthesis});
...
activity and a description of their use. Its texts are taken from Gimpel et al.\ (2023)%
...
and licensed under CC BY-SA 4.0; the source is printed below the form. For example,
%
\begin{LaTeXCode}[numbers=none]
...
\begin{itemize}
	...
	\item \verb!\aifurtheruse{<text>}!: further use of AI tools (optional).
\end{itemize}
